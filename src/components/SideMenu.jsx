      ...
      <div className="flex flex-col gap-2 text-sm">
        <label className="flex items-center gap-2 cursor-pointer">
          <input
            ...
            name="sort"
            value="newest"
            className="appearance-none w-4 h-4 border-[1.5px] border-blue-800 cursor-pointer bg-white rounded checked:bg-blue-800"
          />Newest
        </label>
        <label className="flex items-center gap-2 cursor-pointer">
          <input
        ...
        <div>
          <h1 className="mt-8 mb-4 text-sm font">Categories</h1>
          <div className="flex flex-col gap-2 text-sm">
